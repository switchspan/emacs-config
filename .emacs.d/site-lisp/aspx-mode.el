...
(provide 'aspx-mode);;; aspx-mode.el --- mode for editing ASPX files
;;
;; Copyright (C) 2010  Dino Chiesa
;;
;; Author:   Dino Chiesa <dpchiesa@hotmail.com>
...
(require 'multi-mode)
;;(require 'csharp-mode)
(require 'vbnet-mode "vbnet-mode.el")
(require 'espresso "espresso.el")
;;(require 'javascript-mode "javascript.el")
(require 'css-mode)
        ...
        (save-restriction
          ...
          (cond
           ...
           ((save-excursion
            ...
            ;; TODO: support csharp-mode, too.  Check the language at the
            ;; start block.
            (setq mode 'csharp-mode
                  start-of-block sp
                  end-of-block (1- ep) ))
           ...
           ((save-excursion
            ...
            ;; TODO: support csharp-mode, too.  Check the specified language at the
            ;; start block.
            ;; This works only because csharp-mode has smarts to fontify the
            ;; @Page directive.
            (setq mode 'csharp-mode
